...
@dso_cache = dso_local local_unnamed_addr global [546 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 90634744, ; hash 0x566f9f8, from name: Myfamily1.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 388877353, ; hash 0x172dcc29, from name: Myfamily1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Myfamily1.dll.so
		ptr null; void* handle (0x0)
	}, ; 46
	...
	%struct.DSOCacheEntry {
		i64 1210833890, ; hash 0x482bdbe2, from name: libaot-Myfamily1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Myfamily1.dll.so
		ptr null; void* handle (0x0)
	}, ; 145
	...
	%struct.DSOCacheEntry {
		i64 1527489104, ; hash 0x5b0ba250, from name: aot-Myfamily1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Myfamily1.dll.so
		ptr null; void* handle (0x0)
	}, ; 190
	...
	%struct.DSOCacheEntry {
		i64 1590671854, ; hash 0x5ecfb9ee, from name: libaot-Myfamily1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Myfamily1.dll.so
		ptr null; void* handle (0x0)
	}, ; 192
	...
	%struct.DSOCacheEntry {
		i64 3688654131, ; hash 0xdbdc6533, from name: aot-Myfamily1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Myfamily1.dll.so
		ptr null; void* handle (0x0)
	}, ; 475
